...
write.table(ANBO_85, file = "ANBO_85_new.csv", sep = ",", col.names = TRUE, row.names=FALSE, append = FALSE)
...
write.table(ANBO_45, file = "ANBO_45_new.csv", sep = ",", col.names = TRUE, row.names=FALSE, append = FALSE)
